      ...
      {loading ? (
        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-300 to-gray-100">
          <div className="flex-grow flex items-center justify-center">
            <div className="bg-white p-10 rounded-lg shadow-lg max-w-md w-full mt-10 mb-10 sm:mt-20 sm:mb-20 sm:p-12">
              <h2 className="text-3xl font-bold text-gray-800 text-center sm:text-4xl">
                Sign In
              </h2>
              <p className="text-center text-gray-400 text-sm mt-2 mb-8 sm:mt-3 sm:mb-10">
                Sign In to{" "}
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="mb-6 flex items-center">
                  <FaEnvelope className="text-gray-500 mr-2 w-6 h-6" />
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div className="mb-6 flex items-center relative">
                  <FaLock className="text-gray-500 mr-2 w-6 h-6" />
                  <input
                ...
                <button
                  type="submit"
                  className="w-full p-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 text-lg"
                >
                  Login
                </button>
              </form>
